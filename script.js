document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateForce() {
    ...
    spring.style.width = `${300 + x * 2}px`;
    spring.style.height = `${100 + k * 1000}px`;
    arrow.style.width = `${0 + x}px`;
    arrow.style.height = "50px"; // 높이 고정
    arrow.style.left = `${50 + x}px`; // 기본 위치 + 슬라이더 값
